...
import { singleProductByIDs } from '../services';
...
const ProductDetail = () => {
    ...
    useEffect(() => {
        async function fechProduct() {
            const data = await singleProductByIDs(id);
            setProduct(data);
        }
        fechProduct();
    }, [id])
                ...
                <div className="flex flex-wrap justify-around">
                    ...
                    <div className="max-w-xl my-3">
                        ...
                        <p className="my-4 select-none">
                            ...
                            {!product.best_seller && <span className="font-semibold text-rose-700 border bg-slate-100 rounded-lg px-3 py-1 mr-2">OUT OF STOCK</span>}
